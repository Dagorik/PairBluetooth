package com.pairbluetooth.mariachiio.dagorik.pairbluetooth.test_bluetooth.test_bluetooth.test_bluetooth;
...
public class BluetoothDemo extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Log.i("Log", "arrayListBluetoothDevices: " + arrayListBluetoothDevices.toString());
    }
    ...
    private void getPairedDevices() {
        ...
        if (pairedDevice.size() > 0) {
            for (BluetoothDevice device : pairedDevice) {
                ...
                Log.i("Log", "arrayListBluetoothDevices: " + arrayListBluetoothDevices.size());
            }
        }
        Log.i("Log", "arrayListBluetoothDevices: " + arrayListBluetoothDevices.size());
...
//                    arrayListBluetoothDevices.clear();
    ...
    private void startSearching() {
        ...
        if (BluetoothAdapter.ACTION_DISCOVERY_FINISHED.equals(intentFilter)) {
